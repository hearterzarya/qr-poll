  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        glass:
          "glass text-foreground hover:border-primary/30 hover:bg-accent/50",
        emergency:
          "bg-destructive text-white shadow-xl shadow-destructive/40 hover:bg-destructive/90 emergency-pulse text-base font-bold",
      },
      size: {
        default: "h-11 px-5 py-2",
        sm: "h-9 rounded-lg px-3 text-xs",
        lg: "h-13 rounded-xl px-8 text-base min-h-[52px]",
        xl: "h-16 rounded-2xl px-8 text-lg min-h-[64px]",
        icon: "h-11 w-11",
      },
    },
    defaultVariants: {
